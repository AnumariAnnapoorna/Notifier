...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action='editNoteDetails.jsp' method="post">
    ...
    <div class="container">
      ...
      <input type="text" value=<%=request.getParameter("NoteName") %> name="nname" readonly>  
      <input type="hidden" value=<%=request.getParameter("NotebookId") %> name="noteid">  
